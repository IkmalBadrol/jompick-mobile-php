...
if ($userID !== null && $itemID !== null) {
    ...
    $sql = "INSERT INTO confirmation (status, pickUpDuration, currentLocation, confirmationDate, pickUpLocation_id) VALUES (".$status", ".$pickUpDuration",".$currentLocation", ".$confirmationDate", ".$pickUpLocation_id")";
